...
export default function FeaturedBundle() {
    ...
    useEffect(() => {
        const fetchBundleData = async () => {
            try {
                ...
                if (!featuredRes.ok) {
                    throw new Error(
                        `Featured API failed: ${featuredRes.status}`,
                    );
                }
                ...
                const bundleInfo = bundleInfoData.data.find(
                    (bundle: any) => bundle.uuid === featured.bundle_uuid,
                );
    ...
    return (
        <div className="w-full max-w-5xl mx-auto px-4">
            ...
            <Link
                href={`/skins?search=${bundleData.displayName}`}
                    ...
                    {bundleData.displayIcon && (
                        <figure className="mb-4">
                            <Image
                                ...
                                alt={bundleData.displayName || "Unknown Skin"}
